...
def all_detection(nose_x, nose_y,                               # 鼻子（0点）的 x 坐标 和 y 坐标
    ...
    ditou_inclination_left = findAngle(left_mouth_x, left_mouth_y, left_shoulder_x, left_shoulder_y)
    ditou_inclination_right = findAngle(right_mouth_x, right_mouth_y, right_shoulder_x, right_shoulder_y)
